...
#Use the linear search algorithm to implement the logic for the number guessing game that you had played.
#The program should display the total number of guesses made each time you play.
...
def find_it(num,element_list):
    ...
    for i in element_list:
        if(i!=num):
            count+=1
        if(i == num):
            return print("Number of guesses: ",count)
